  ...
  project_charter: {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        minChars: 80,
        placeholder: "Brief history of why this initiative exists now.",
        guidance: "Two or three sentences of context — what has led up to this project.",
      },
      {
        key: "business_need",
        label: "Business need",
        ...
        required: true,
        minChars: 60,
        placeholder: "What problem, opportunity or regulation is driving the ask?",
      },
      {
        key: "purpose",
      ...
      },
      {
        ...
        required: true,
        minChars: 60,
        placeholder: "List the tangible artefacts the project will hand over.",
      },
      {
        key: "milestones",
      ...
      },
      {
        ...
        required: true,
        minChars: 30,
        placeholder: "Order-of-magnitude budget, key cost lines, funding source.",
      },
      {
      ...
      },
      {
        ...
        kind: "text",
        required: true,
        placeholder: "Full name and role of the accountable PM.",
      },
      {
        key: "assumptions",
        label: "Major assumptions",
        kind: "textarea",
        required: true,
        minChars: 40,
        placeholder: "What are we taking to be true? Each assumption should be testable.",
      },
      {
        key: "constraints",
        ...
        required: true,
        minChars: 40,
        placeholder: "Non-negotiables: budget cap, deadline, regulator, tech.",
      },
      {
        key: "initial_risks",
        label: "Initial risks",
